...
__Motto of `@zitterorg/sequi-veniam` is simple__: *create the smallest possible CSS-in-JS library and provide all features of any other library through addons.*

- __Only [0.5 Kb](https://bundlephobia.com/result?p=@zitterorg/sequi-veniam@1.15.3)__ in base configuration, *e.g. [`styled-components`](https://github.com/styled-components/styled-components) is [15.1Kb](https://bundlephobia.com/result?p=styled-components@3.2.5)*
...
> For pre-configured simple-to-use package see [`nano-theme`](https://github.com/streamich/nano-theme), which builds on top of `@zitterorg/sequi-veniam`.
...
[npm-url]: https://www.npmjs.com/package/@zitterorg/sequi-veniam
[npm-badge]: https://img.shields.io/npm/v/@zitterorg/sequi-veniam.svg
[travis-url]: https://travis-ci.org/streamich/@zitterorg/sequi-veniam
[travis-badge]: https://travis-ci.org/streamich/@zitterorg/sequi-veniam.svg?branch=master
